...
<form:form modelAttribute="editFinder" action="handy-worker/finder/edit.do">
    <form:hidden path="id"/>
    <form:hidden path="version" />

    <security:authorize access="hasRole('handy-worker')" >

    <form:label path="keyWord" placeholder= "<spring:message code='handyWorker.keyWord'/>"/>
        <form:input path="${handyWorker.finder.keyWord}"/>
    <form:label path="minPrice" placeholder="<spring:message code='handyWorker.minPrice'/>"/>
        <form:input path="${handyWorker.finder.minPrice}" />
    <form:label path="maxPrice" placeholder="<spring:message code='handyWorker.maxPrice'/>"/>
