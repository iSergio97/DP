...
<display:table name="listFinder" id="listFinder" requestURI="/handy-worker/finder/show.do" pagesize="5" class="displaytag">
    <security:authorize access="hasRole('handy-worker')" >
        ...
        <display:column property="<spring:message code='handyWorker.finder.ticker' />" titleKey="handyWorker.finder.keyWord" />
        <display:column property="<spring:message code='handyWorker.finder.minPrice'/>" titleKey="handyWorker.finder.minimumPrice" />
        <display:column property="<spring:message code='handyWorker.finder.maxPrice'/>" titleKey="handyWorker.finder.maximumPrice" />
