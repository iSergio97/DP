...
<a href="show.do?id=${customer.id}"><spring:message code="fixUpTask.toProfile" /></a>
...
<display:table name="fixUpTasks" id="row"
	...
	<display:column> <a href="fixUpTask/customer/show.do?fixUpTaskId=${row.id}"> <jstl:out value="Show"/></a> </display:column>
	

</display:table>

<a href="fixUpTask/customer/create.do">New</a>